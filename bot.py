...
@app_commands.describe(query="Tags cách nhau bằng dấu cách. Ví dụ: asian blowjob pov")
...
@app_commands.describe(tags="Tags cách nhau bằng dấu cách. Ví dụ: asian anal cum_in_mouth")
